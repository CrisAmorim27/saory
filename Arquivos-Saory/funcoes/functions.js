...
fs.writeFileSync('./Arquivos-Saory/sticker/data.exif', Buffer.concat([_, __, ___, ____]), function (err) {
console.log(err)
if (err) return console.error(err)
return `./Arquivos-Saory/sticker/data.exif`
})
}
...
const banner2 = cfonts.render((`SAORY BOT OFC
> CRIADOR: Gabriel7
> NUMERO: +55 85 9254-9207
> PLATAFORMA: PRIVADO
> BOT: SAORY BOT
> VERSAO: V5.6
> ATUALIZADO:
...
const banner3 = cfonts.render((`SAORY BOT V5`), {
font: 'slick',             
align: 'center',
colors: [`cyan`,`cyan`],
